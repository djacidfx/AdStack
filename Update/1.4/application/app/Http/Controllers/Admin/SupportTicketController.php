...
class SupportTicketController extends Controller
{
    ...
    public function tickets()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->with(['advertiser','publisher'])->paginate(getPaginate());
    ...
    public function pendingTicket()
    {
        ...
        $items = SupportTicket::whereIn('status', [0,2])->orderBy('id','desc')->with(['advertiser','publisher'])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function closedTicket()
    {
        ...
        $items = SupportTicket::where('status',3)->orderBy('id','desc')->with(['advertiser','publisher'])->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
    ...
    public function answeredTicket()
    {
        ...
        $items = SupportTicket::orderBy('id','desc')->with(['advertiser','publisher'])->where('status',1)->paginate(getPaginate());
        return view('admin.support.tickets', compact('items', 'pageTitle'));
    }
