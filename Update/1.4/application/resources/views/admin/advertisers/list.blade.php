...
@section('panel')
@include('admin.components.tabs.advertisers')
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="table-responsive--md  table-responsive">
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('admin.advertisers.detail', $user->id) }}">{{@$user->fullname}}
                                        ({{$user->username}})</a>
                                </td>
                                ...
                                <td>
                                    <a title="@lang('User Profile')" href="{{ route('admin.advertisers.detail', $user->id) }}"
