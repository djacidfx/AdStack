...
<div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn--primary unblockipBtn" data-id="{{$log->ip->id}}" title="@lang('Unblock IP')">
 ...
 {{-- unblock ip modal --}}
 <div id="unblockipBtnModal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('IP Unblock Confirmation')</h5>
                <button type="button" class="close btn btn--danger btn--sm" data-bs-dismiss="modal" aria-label="Close">
                    <i class="las la-times"></i>
                </button>
            </div>
            <form action="{{route('admin.advertise.ads.unblockedip')}}" method="POST">
                @csrf
                <input type="hidden" name="id">
                <div class="modal-body">
                    <p>@lang('Are you sure to') <span class="fw-bold">@lang('unblock')</span> <span
...
@push('script')
    <script>
        ...
        $('.unblockipBtn').on('click', function() {
            var modal = $('#unblockipBtnModal');
