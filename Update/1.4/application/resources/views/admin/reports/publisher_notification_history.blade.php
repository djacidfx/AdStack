                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($log->publisher)
                                    <a href="{{ route('admin.publishers.detail', $log->publisher->id) }}">
                                        {{  @$log->publisher->fullname }}
                                    </a>
...
@if(@$user)
<a href="{{ route('admin.publishers.notification.single',$user->id) }}" class="btn btn--primary btn-sm"><i
