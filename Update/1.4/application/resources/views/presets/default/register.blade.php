                    ...
                    <div class="log-in-box wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                        ...
                        <ul class="nav nav-tabs coustome-tabs" role="tablist">
                          <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="basic-tab" data-bs-toggle="tab" data-bs-target="#basic" type="button" role="tab" aria-selected="false" tabindex="-1">@lang('Publisher')</button>
                          </li>
                          <li class="nav-item" role="presentation">
                            <a href="{{route('advertiser.register')}}" class="nav-link">@lang('Advertiser')</a>
                          </li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="basic" role="tabpanel" aria-labelledby="basic-tab">
                                <div class="sign-up_box wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <form action="{{ route('publisher.register') }}" method="POST" class="verify-gcaptcha">
                                        @csrf
                                        <div class="row wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                                            <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                                                <div class="form-group">
                                                    <input type="text" class="form--control checkPublisher" id="username" name="username" value="{{ old('username') }}" placeholder="" required>
                                            ...
                                            <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                                                <div class="form-group">
                                                    <input type="email" class="form--control checkPublisher" id="email" name="email" value="{{ old('email') }}" placeholder="" required>
                                            ...
                                            <div class="col-xxl-6 col-lg-6 col-md-6 mb-3">
                                                <div class="form-group">
                                                    <div class="input-group country-code">
                                                        ...
                                                        <input type="text" class="form--control checkPublisher"  name="mobile" value="{{ old('mobile') }}" placeholder="@lang('Mobile')">
                                                    </div>
                                        ...
                                        <div class="mb-3 form--check wow animate__animated animate__fadeInUp" data-wow-delay="0.9s">
                                            ...
                                            <label class="form-check-label" for="defaultCheck">
                                                ...
                                                <a class="" href="{{ route('policy.pages',[slug($policy->data_values->title),$policy->id]) }}" class="text--base">{{ __($policy->data_values->title) }}
                                                </a>
                                                @endforeach
                                            </label>
                                        </div>
                                        @endif
                                          ...
                                          <p class="pt-3 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">@lang('Already have an account?') <a href="{{ route('login') }}" class="text--base">@lang('Login')</a></p>
