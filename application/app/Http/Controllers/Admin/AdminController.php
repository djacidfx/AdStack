...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $widget['verified_users'] = Advertiser::where('status', 1)->where('ev', 1)->where('sv', 1)->count();
        $widget['email_unverified_users'] = Advertiser::emailUnverified()->count();
        $widget['mobile_unverified_users'] = Advertiser::mobileUnverified()->count();

        // publishers
        $publisher['total_users'] = Publisher::count();
        $publisher['verified_users'] = Publisher::where('status', 1)->where('ev', 1)->where('sv', 1)->count();
        $publisher['email_unverified_users'] = Publisher::emailUnverified()->count();
        $publisher['mobile_unverified_users'] = Publisher::mobileUnverified()->count();
       ...
       ->pluck('login_count', 'login_date');
        ...
        // UserLogin Report Graph
        $newTickets = SupportTicket::with(['advertiser', 'publisher'])->orderBy('created_at', 'desc')->whereStatus(0)->limit(5)->get();
        return view('admin.dashboard', compact('pageTitle', 'widget', 'withdrawalsChart', 'depositsChart', 'deposit', 'withdrawals', 'userLogins', 'newTickets', 'publisher'));
    }
