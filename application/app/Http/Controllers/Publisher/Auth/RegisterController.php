...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        $exist = Publisher::where('mobile',$request->mobile_code.$request->mobile)->first();
        if ($exist) {
    ...
    protected function create(array $data)
    {
        ...
        if ($referBy) {
            $referUser = Publisher::where('username', $referBy)->first();
        } else {
            $referUser = null;
        }
        //User Create
        ...
        $adminNotification->click_url = urlPath('admin.publishers.detail',$user->id);
    ...
    public function checkPublisher(Request $request){
        ...
        if ($request->mobile) {
            $exist['data'] = Publisher::where('mobile',$request->mobile)->exists();
            $exist['type'] = 'mobile';
        }
        if ($request->username) {
