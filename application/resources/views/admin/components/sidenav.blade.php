<div class="sidebar">
    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.advertisers.*')}}">
                    <a href="{{route('admin.advertisers.active')}}" class="nav-link ">
                        <i class="menu-icon las la-user"></i>
                        <span class="menu-title">@lang('All Advertisers')</span>
                        @if($bannedUsersCount > 0 || $emailUnverifiedUsersCount > 0 || $mobileUnverifiedUsersCount > 0)
                        <div class="blob white"></div>
                        @endif
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.publishers.*')}}">
                    <a href="{{route('admin.publishers.active')}}" class="nav-link ">
                        <i class="menu-icon las la-user"></i>
                        <span class="menu-title">@lang('All Publishers')</span>
                        @if($publisherBannedUsersCount > 0 || $publisherMailUnverifiedUsersCount > 0 || $publisherMobileUnverifiedUsersCount > 0)
                        <div class="blob white"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.advertise.ads.*',3)}}">
                        <i class="menu-icon las la-ad"></i>
                        <span class="menu-title">@lang('Ads Management')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.advertise.ads.*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.advertise.ads.advertise.all')}}">
                                <a href="{{ route('admin.advertise.ads.advertise.all') }}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('All Ads')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.advertise.ads.adType.index')}}">
                                <a href="{{ route('admin.advertise.ads.adType.index') }}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('Ads Type')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.advertise.ads.keyword.index')}}">
                                <a href="{{route('admin.advertise.ads.keyword.index')}}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('Keywords')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.advertise.ads.iplog')}}">
                                <a href="{{route('admin.advertise.ads.iplog')}}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('Ip Logs')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.advertise.ads.blockiplog')}}">
                                <a href="{{route('admin.advertise.ads.blockiplog')}}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
                                    <span class="menu-title">@lang('Block Ip Logs')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.domain.*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.domain.get.approved')}}">
                                <a href="{{ route('admin.domain.get.approved') }}" class="nav-link">
                                    <i class="menu-icon las la-caret-right"></i>
    ...
    <li class="sidebar-menu-item {{menuActive('admin.report.notification.history')}}">
        <a href="{{route('admin.report.advertiser.notification.history')}}" class="nav-link">
