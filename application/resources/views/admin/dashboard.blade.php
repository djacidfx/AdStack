        ...
        <div class="row gy-4">
            ...
            <div class="col-sm-12">
                <div class="card p-3 rounded-3">
                    <h5 class="text-center mb-3">@lang('Advertisers')</h5>
                    <div class="row g-0">
                            ...
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.advertisers.all')}}"></a>
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4 ">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.advertisers.active')}}"></a>
                        ...
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.advertisers.email.unverified')}}"></a>
            ...
            <div class="col-sm-12">
                <div class="card p-3 rounded-3">
                    <h5 class="text-center mb-3">@lang('Publishers')</h5>
                    <div class="row g-0">
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                <div class="dashboard-widget__icon">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.publishers.all')}}"></a>
                                    <h5>{{$publisher['total_users']}}</h5>
                                    <span>@lang('Total Users')</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4 ">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.publishers.active')}}"></a>
                                    <h5>{{$publisher['verified_users']}}</h5>
                                    <span>@lang('Active Users')</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                            <div class="dashboard-widget">
                                ...
                                <div class="dashboard-widget__content">
                                    <a title="@lang('View all')" class="dashboard-widget-link"
                                        href="{{route('admin.publishers.email.unverified')}}"></a>
                                    <h5>{{$publisher['email_unverified_users']}}</h5>
                                    <span>@lang('Email Unverified')</span>
                                </div>
