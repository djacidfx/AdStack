                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($log->advertiser)
                                    <a href="{{ route('admin.advertisers.detail', $log->advertiser->id) }}">
                                        {{ @$log->advertiser->fullname }}
                                    </a>
                                    @else
...
@if(@$user)
<a href="{{ route('admin.advertisers.notification.single',$user->id) }}" class="btn btn--primary btn-sm"><i
