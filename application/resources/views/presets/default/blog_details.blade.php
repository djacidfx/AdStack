                  ...
                  <div class="blog-details">
                      ...
                      <div class="blog-item">
                          <div class="blog-item__thumb">
                              <img src="{{ getImage(getFilePath('blog') . '/' . $blog->data_values->blog_image) }}" alt="@lang('blog img')">
                          </div>
                     ...
                     <div class="blog-details__content wyg">
                          ...
                          <div class="blog-details__share d-flex align-items-center flex-wrap">
                            ...
                            <ul class="social-list blog-details">
                                <li class="social-list__item blg-social-list" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <li class="social-list__item blg-social-list" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Linkedin"> <a class="social-list__link" target="_blank"
                                        href="https://www.linkedin.com/shareArticle?mini=true&url={{ Request::url() }}&title={{ slug(@$blog->data_values->title) }}&source=behands"><i
