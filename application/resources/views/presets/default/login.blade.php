                        ...
                        <ul class="nav nav-tabs coustome-tabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="basic-tab" data-bs-toggle="tab" data-bs-target="#basic"
                                    ...
                                    tabindex="-1">@lang('Publisher')</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('advertiser.login')}}" class="nav-link">@lang('Advertiser')</a>
                            </li>
                        </ul>
                                ...
                                <div class="row justify-content-center">
                                    <div
                                        ...
                                        <div class="login wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                                            ...
                                            <form method="POST" action="{{route('publisher.login')}}" class="verify-gcaptcha">
                                                @csrf
                                                ...
                                                <div class="login-meta mb-3 wow animate__animated animate__fadeInUp"
                                                    ...
                                                    <a href="{{ route('publisher.password.request') }}">@lang('Forgot Your Password?')</a>
                                                </div>
                                            ...
                                            <p class="pt-3 wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                                                @lang('Don\'t have any account?') <a href="{{ route('register') }}" class="text--base">
