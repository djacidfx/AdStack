                ...
                <input type="hidden" name="plan_id" value="{{$plan->id}}">
                    <div class="form-group mb-3">
                        <select class="select form--control" name="gateway" required>
                            ...
                            <option value="balance">@lang('Account Balance') {{ $general->cur_sym }}{{showAmount(auth()->guard('advertiser')->user()->balance) }}</option>
                    ...
                    <div class="form-group mb-3">
                        <div class="input-group">
                            <input type="number" step="any" name="amount" class="form--control"
                                value="{{$plan->price}}" autocomplete="off" required placeholder=" ">
